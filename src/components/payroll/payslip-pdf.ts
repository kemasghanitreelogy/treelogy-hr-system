...
> = {
  id: {
    ...
    generated: (timestamp) => `Dokumen dihasilkan otomatis oleh Treelogy Workspace · ${timestamp} WITA`,
  },
  en: {
    docTitle: "PAYSLIP",
    ...
    generated: (timestamp) => `Automatically generated by Treelogy Workspace · ${timestamp} WITA`,
  },
};
