...
export const STR: Record<Locale, Record<string, string>> = {
  id: {
    ...
    tags: "Tag tambahan",
    tagsHint: "Pisahkan dengan koma. Tag admin-created selalu ditambahkan otomatis.",
    advanced: "Pengaturan lanjutan",
    seedDate: "Tanggal seed (opsional)",
    seedDateHint:
      "Kosong = sentinel 2000-01-01 (lolos cutoff apa pun). Isi hanya kalau butuh cutoff khusus; harus lebih awal dari purchasedBefore campaign.",
    campaignKeys: "Campaign key (opsional)",
    campaignKeysHint: "Kosong = semua campaign aktif. Pisahkan dengan koma, mis. cd_abc123.",
    submit: "Buat & grant",
    ...
    dropHint: "CSV, XLSX. Kolom yang dikenali: email (wajib), nama_depan, nama_belakang atau nama, tags.",
    ...
    extraTags: "Tag untuk semua baris",
    extraTagsHint: "Opsional. Ditambahkan ke setiap pelanggan dalam berkas ini, mis. kampanye-sept.",
    process: "Proses",
    rows: "baris",
  ...
  en: {
    ...
    lastName: "Last name",
    tags: "Extra tags",
    tagsHint: "Comma-separated. The admin-created tag is always added automatically.",
    advanced: "Advanced",
    seedDate: "Seed date (optional)",
    seedDateHint:
      "Empty = the 2000-01-01 sentinel (passes any cutoff). Only set it for a specific cutoff; it must be earlier than the campaign's purchasedBefore.",
    campaignKeys: "Campaign keys (optional)",
    campaignKeysHint: "Empty = all active campaigns. Comma-separated, e.g. cd_abc123.",
    submit: "Create & grant",
    ...
    dropHint: "CSV, XLSX. Recognised columns: email (required), first_name, last_name or name, tags.",
    ...
    extraTags: "Tags for every row",
    extraTagsHint: "Optional. Added to every customer in this file, e.g. sept-campaign.",
    process: "Process",
    rows: "rows",
