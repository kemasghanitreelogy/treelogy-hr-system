...
const ORDER: Record<Audience, string[]> = {
  ops: ["/dashboard", "/attendance", "/leave", "/overtime", "/payroll", "/employees", "/org-structure", "/shifts", "/holidays", "/travel", "/payment-requests", "/inventory", "/access", "/super-admin"],
  self: ["/dashboard", "/attendance", "/leave", "/overtime", "/payroll", "/holidays", "/shifts", "/travel", "/payment-requests", "/inventory", "/employees", "/org-structure", "/access", "/super-admin"],
};
