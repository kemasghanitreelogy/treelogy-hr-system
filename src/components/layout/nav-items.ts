...
const ITEMS: Record<string, NavItem> = {
  ...
  "/documents": { href: "/documents", label: "Dokumen", labelEn: "Documents", icon: FolderOpen, perm: "documents.view" },
  ...
  "/reimbursements": { href: "/reimbursements", label: "Reimbursement Dinas", labelEn: "Travel Reimbursement", icon: Receipt, perm: "reimbursement.view" },
...
const ORDER: Record<Audience, string[]> = {
  ops: ["/dashboard", "/attendance", "/leave", "/overtime", "/payroll", "/employees", "/org-structure", "/shifts", "/holidays", "/travel", "/reimbursements", "/payment-requests", "/inventory", "/documents", "/letters", "/access", "/super-admin"],
  self: ["/dashboard", "/attendance", "/leave", "/overtime", "/payroll", "/holidays", "/shifts", "/travel", "/reimbursements", "/payment-requests", "/inventory", "/documents", "/letters", "/employees", "/org-structure", "/access", "/super-admin"],
};
