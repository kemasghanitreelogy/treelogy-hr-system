...
const ORDER: Record<Audience, string[]> = {
  ops: ["/dashboard", "/attendance", "/leave", "/overtime", "/payroll", "/employees", "/org-structure", "/shifts", "/holidays", "/travel", "/payment-requests", "/inventory", "/documents", "/access", "/super-admin"],
  self: ["/dashboard", "/attendance", "/leave", "/overtime", "/payroll", "/holidays", "/shifts", "/travel", "/payment-requests", "/inventory", "/documents", "/employees", "/org-structure", "/access", "/super-admin"],
};
